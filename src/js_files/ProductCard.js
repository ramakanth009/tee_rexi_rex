...
export default function ProductCard(props) {
  ...
  /**
   * Function which is used to show and hide required message on product card
   * @param {string} message
   * Message will be shown in product card according to the requirement.
   * We show the required message and hide it after the timer goes off (by setting message to '')
   */
   ...
   *
   * checkItemInCart function is called here, which takes nameOfProductUserWantsToAdd and
  ...
  return (
    <div>
      ...
      <div class="add-to-cart" >
        <Button
          onClick={() => addingProductToCart(localStorage, props)}
          // variant="contained"
          fullWidth
        >
